...
void max7219_write(uint8_t address, uint8_t data){
 LATAbits.LATA2 = 0;
  SSPBUF = address;while (SSPSTATbits.BF) __nop();
  SSPBUF = data;while (SSPSTATbits.BF) __nop();
 LATAbits.LATA2 = 1;
}
# 87 "main.c"
void main(){
 ...
 while (1){
  ...
  if ( Buffer.index >= 6 ){
   ...
   if ( Buffer.data[5] == '\r' || Buffer.data[5] == '\n' ){
    ...
    max7219_write(1, Buffer.data[0]);
    max7219_write(2, Buffer.data[1]);
    max7219_write(3, Buffer.data[2]);
